> **Important Warning**
> This project is based on [barcode by ShockOfWave](https://github.com/ShockOfWave/barcode).
> **Please note when using:** the output of autocorrelation functions (both in tables and in graphs) in this implementation is **incorrect**.
> For correct autocorrelation analysis, use the attached Wolfram Mathematica file (`acfs.nb`).
>
> The original is licensed under the MIT license (see the LICENSE file).
# Barcode project
